      ...
      {showMenu && (
        ...
        >
          <Link
            ...
            href={"/developer"}
            className="w-full flex items-center justify-between rounded-md p-3 transition-all cursor-pointer hover:dark:bg-neutral-800 hover:dark:border-neutral-600 border border-transparent"
          >
          ...
          <Link
            target="_blank"
            href={"https://github.com/parsaprog/Alex"}
            className="w-full flex items-center justify-between rounded-md p-3 transition-all cursor-pointer hover:dark:bg-neutral-800 hover:dark:border-neutral-600 border border-transparent"
          >
            <div className="flex items-center gap-x-2 dark:text-neutral-200 text-neutral-900">
              <Github size={15} />
          ...
          <Link
            onClick={() => setShowMenu(false)}
            href={"/book?tab-index=contributors"}
            className="w-full flex items-center justify-between rounded-md p-3 transition-all cursor-pointer hover:dark:bg-neutral-800 hover:dark:border-neutral-600 border border-transparent"
          >
            <div className="flex items-center gap-x-2 dark:text-neutral-200 text-neutral-900">
              <Users2 size={15} />
          ...
          <Link
            onClick={() => setShowMenu(false)}
            href={"/book?tab-index=book-info"}
            className="w-full flex items-center justify-between rounded-md p-3 transition-all cursor-pointer hover:dark:bg-neutral-800 hover:dark:border-neutral-600 border border-transparent"
          >
            <div className="flex items-center gap-x-2 dark:text-neutral-200 text-neutral-900">
              <BookOpenText size={15} />
              <h3 className="text-sm">
                {lang === "en" ? "Book Information" : "اطلاعات کامل کتاب"}
              </h3>
            </div>
            <OpenIcon />
          </Link>
